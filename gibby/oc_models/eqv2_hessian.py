...
from ocpmodels.models.equiformer_v2.transformer_block import (
    FeedForwardNetwork,
...
class EquiformerV2_OC20_Hessian(BaseModel):
    """
    ...
    def forward(self, data):
        ...
        if self.regress_forces:
            ...
            self.hessian = compute_hessian_autograd(forces=forces, positions=data.pos)
